...
export default class TopicComponentsPage extends AlertPage {
...
export class TopicDeleteDialog {
  ...
  title: ElementFinder = element(by.id('katoviApp.topic.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-topic'));
}
