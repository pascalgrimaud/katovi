...
describe('Message e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Message page', async () => {
      ...
      expect(await updatePage.title.getText()).to.match(/Create or edit a Message/);
    });
    ...
    /* it('should create and save Messages', async () => {
      ...
      // await  selectLastOption(updatePage.topicSelect);
    ...
    describe('Details, Update, Delete flow', () => {
      ...
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/katoviApp.message.delete.question/);
